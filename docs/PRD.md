...
|-----------|-------------|------------|-----------|
| **Время** | Часы мониторинга цен на Aviasales, Yandex Travel, Google Flights | Push/Telegram "Покупай сейчас" в нужный момент | 10x |
...
- **Кто:** 18-25 лет, доход <₽60,000/мес, mobile-first, Telegram-native
- **JTBD:** "Хочу забронировать поездку с друзьями за 5 минут в Telegram и иметь возможность отменить бесплатно"
- **Текущее решение:** Aviasales + TikTok travel hacks
- **Триггер:** Друг скинул deal в чат, внезапные каникулы, viral trip idea
