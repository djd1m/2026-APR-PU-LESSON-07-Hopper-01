 ...
 *
 * Displays real pricing and descriptions for each protection type:
 * - CFAR: 15-20% of booking, 100% refund, АльфаСтрахование partner
 * - Price Drop: 1,000-2,000 RUB, 10-day monitoring, auto-refund difference
 */
export function ProtectionCheckbox({
  ...
  // Max coverage display for Price Drop
  const maxCoverage = useMemo(() => {
    if (type !== 'price_drop' || !bookingPrice) return null;
    return Math.round(bookingPrice * 0.5);
  }, [type, bookingPrice]);
      ...
      case 'price_drop':
        return {
          ...
          details: [
            ...
            'Проверка каждые 30 минут (автоматически)',
            'Автоматический возврат разницы — без заявки',
            maxCoverage
              ? `Макс. возврат: ${formatPrice(maxCoverage)} (50% стоимости билета)`
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              {effectiveRate !== null && type === 'cancel_for_any_reason' && (
          ...
          {/* Insurance partner badge for CFAR */}
          {typeConfig.badge && (
            <span
